...
const StartupForm = () => {
    ...
    const handlfeFormSubmit = async (prevState: any, formData: FormData) => {
        try {
            const formValues = {
            ...
            if (result.status == 'SUCCESS') {
                ...
                toast({
                    title: 'Success',
                    description: 'Startup has submitted successfuly',
                });
    ...
    const [state, formAction, isPending] = useActionState(handlfeFormSubmit, {
        error: '',
        status: 'initial'
    });
